...
RECORDS_REST_ENDPOINTS = {
    'recid': dict(
        ...
        search_type=None,
        record_serializers={
            'application/json': ('testinvenio.records.serializers'
                                 ':json_v1_response'),
        },
        search_serializers={
            'application/json': ('testinvenio.records.serializers'
        ...
        record_loaders={
            'application/json': ('testinvenio.records.loaders'
                                 ':json_v1'),
        },
        list_route='/records/',
        item_route='/records/<pid(recid,'
                   'record_class="testinvenio.records.api.Record")'
                   ':pid_value>',
...
FILES_REST_PERMISSION_FACTORY = \
    'testinvenio.records.permissions:files_permission_factory'
